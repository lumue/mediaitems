...
main: function() {
  var controller = new N.MetadataViewController(null, null);
  controller.init$1(document.querySelector("#content"));
  controller.loadElements$0();
},

MetadataResultView: {"": "Object;tableBodyElement,model,templateRowElement",
  MetadataResultView$1: function(element) {
    var trElement;
    this.tableBodyElement = element.querySelector("#result_body");
    trElement = this.tableBodyElement.querySelector("tr");
    this.templateRowElement = trElement.cloneNode(true);
    trElement.hidden = true;
  },
  static: {
MetadataResultView$: function(element) {
  var t1 = new N.MetadataResultView(null, null, null);
  t1.MetadataResultView$1(element);
  return t1;
}}

},

MetadataViewController: {"": "Object;view,model",
  init$1: function($content) {
    this.view = N.MetadataResultView$($content);
    this.model = new N.MetadataResultViewModel(0, 20, null);
    this.view.model = this.model;
  },
  loadElements$0: function() {
    W.HttpRequest_getString("http://localhost:8080/app/metadata/video/list?from=" + C.JSInt_methods.toString$0(this.model.start) + "&to=" + C.JSInt_methods.toString$0(this.model.pagesize), null, null).then$1(new N.MetadataViewController_loadElements_closure(this));
  }
},

MetadataViewController_loadElements_closure: {"": "Closure;this_0",
  call$1: function(result) {
    this.this_0.model.queryResult = C.C_JsonCodec.decode$1(result);
  },
  $is_args1: true
},

MetadataResultViewModel: {"": "Object;start,pagesize,queryResult"}},
1],
]);
...
function dart_precompiled($collectedClasses) {
  ...
  function MetadataViewController_loadElements_closure(this_0) {
    this.this_0 = this_0;
  }
  MetadataViewController_loadElements_closure.builtin$cls = "MetadataViewController_loadElements_closure";
  if (!"name" in MetadataViewController_loadElements_closure)
    MetadataViewController_loadElements_closure.name = "MetadataViewController_loadElements_closure";
  $desc = $collectedClasses.MetadataViewController_loadElements_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MetadataViewController_loadElements_closure.prototype = $desc;
  function MetadataResultViewModel(start, pagesize, queryResult) {
    this.start = start;
