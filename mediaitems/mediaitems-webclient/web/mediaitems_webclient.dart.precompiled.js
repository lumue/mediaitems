...
["", "mediaitems_webclient.dart", , N, {
  main: function() {
    var controller, t1, t2, t3, t4, t5, t6, t7;
    ...
    t3.type = "video";
    t4 = new N.MetadataItem(null, null);
    t4.name = "Der Grinch";
    t4.type = "video";
    t5 = new N.MetadataItem(null, null);
    t5.name = "Eine sch\u00f6ne Bescherung";
    t5.type = "video";
    t6 = new N.MetadataItem(null, null);
    t6.name = "Der Polarexpress";
    t6.type = "video";
    t7 = new N.MetadataItem(null, null);
    t7.name = "Der goldene Kompass";
    t7.type = "video";
    t2.queryResult = [t3, t4, t5, t6, t7];
    t1.update$0();
  },
  MetadataResultView: {
    ...
    MetadataResultView$1: function(element) {
      var t1, trElement;
      t1 = element.querySelector("#result_body");
  ...
  MetadataResultView_update_closure: {
    ...
    call$1: function(item) {
      var t1, rowElement, t2, t3;
      t1 = this.this_0;
      rowElement = J.clone$1$x(t1.templateRowElement, true);
      t2 = J.getInterceptor$x(rowElement);
      t3 = J.getInterceptor$x(item);
      t2.querySelector$1(rowElement, "#result_item_name").textContent = t3.get$name(item);
      t2.querySelector$1(rowElement, "#result_item_type").textContent = t3.get$type(item);
      t1.tableBodyElement.appendChild(rowElement);
    }
  },
